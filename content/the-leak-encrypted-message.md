...
aliases: ["The Whistleblower Message", "Anonymous Leak", "03:47 Message"]
description: "Encrypted anonymous message from a UMG insider exposing the cover-up of substrate mining incidents and the board's decision to prioritize profit over safety."
tags:
  - leaked
  - whistleblower
  - umg
...
Attached to this message is a document. It's the minutes from an [[board-meeting-minutes-2407-01-15|Executive Board meeting]] held on 2407.01.15. Read it carefully. Read it twice.

Then ask yourself: if nineteen people have vanished under nearly identical circumstances, and the Guild's response is to do _nothing_ because it's "economically unacceptable" to investigate—what happens when it's thirty people? Fifty?

What happens when it's _you_?
...
I've read [[characters/maven-cheung|Maven Cheung's]] [[personal-log-maven-cheung|logs]]. I've read the others. Different people, different sectors, **same pattern**.
...
Something is _wrong_ in the Void Sectors. Something is happening to substrate miners. And the Guild is choosing profit over finding out what.
...
1. **[[characters/dr-helena-sarr|Dr. Helena Sarr]] is not the enemy.** She's one of the only people in the [[concepts/united-mining-guild|Guild]] who gives a damn. If you publish this, protect her. She didn't leak this. She doesn't know I exist. Don't let them retaliate against her.

2. **There are thirty-nine people with access to this document.** I'm one of them. The access log is audited. When you publish, they'll know someone leaked it. They'll investigate. I've covered my tracks, but I might not have covered them well enough.

3. **This is not the only document.** There are incident reports. Black box data. Salvage logs. Psychological evaluations. Substrate composition analyses that don't make sense. I have access to some of it. Not all. But enough.

4. **If you want more, here's how you reach me:**
...
5. **Do not trust official Guild statements.** They will deny this document is real. They will claim it's fabricated. They will threaten legal action. They will try to bury this.
...
- [[locations/sector-19-kappa|Sector 19-Kappa]]: 6 incidents
- [[locations/sector-33-mu|Sector 33-Mu]]: 4 incidents
...
Maven Cheung didn't. He kept drilling because he thought he could handle it. Because the seam was rich. Because he was _so close_.
...
**Encryption Key:** _(Provided via separate channel - check your secure drop)_
...
> **Received:** 2407.03.22 03:47 SST
> **Relay chain:** 7 hops, all nodes burned
> **Origin trace:** FAILED
> **Encryption:** VALID
> **Attachment:** VALID (hash match)
> **Auto-purge:** 71 hours, 43 minutes

---

## See Also

- [[board-meeting-minutes-2407-01-15|Board Meeting Minutes]] — The attached document
- [[characters/maven-cheung|Maven Cheung]] — Case cited by whistleblower
- [[characters/dr-helena-sarr|Dr. Helena Sarr]] — Who the whistleblower defends
- [[concepts/united-mining-guild|United Mining Guild]] — The target of the leak
- [[locations/sector-19-kappa|Sector 19-Kappa]] — High-risk sector cited
